export default [
    ...
    `What is the toddler's gender?`,
    `Did the baby had jaundice (yellowing of a baby’s skin and eyes)?`,
    `Are there any family member that as ASD (Autistic Spectrum Disorder)?`
]